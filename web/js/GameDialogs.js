...
dialog.fr={
  ...
  'cmd_exit': "Au revoir !",
  'cmd_exit_html': "<p>Terminus a été arreté.</p><p>Au revoir !</p>",
  'cmd_cd': "Tu es entrée dans %s. %s",
  'cmd_cd_failed': "Il n'existe aucun lieu appelé %s. Retourne te Coucher.",
  'cmd_cd_flood': "Nope nope nope. Tu ne peux pas te dédoubler et accéder à plusieurs salles en même temps. Seul le grand Tmux peut faire cette prouesse.",
  'cmd_cd_home': "Tu es de retour à la maison !",
  'cmd_cd_no_parent': "Tu ne peux plus rebrousser chemin.",
  'cmd_cd_parent': "Tu es entrée dans %s. %s",
  'cmd_cp_copied': "Just copied %s into %s.",
  'cmd_cp_unknown': "No item of that name to copy.",
  'cmd_help_suggestion': "Écris 'man' pour avoir accès aux informations contenues dans la manuscrit",
  'cmd_less_invalid':"Pick a different item to less.",
  'cmd_less_missing':"There is no %s here.",
  'cmd_man_no_query': "Il faut se poser une question pour être prêt à connaître sa réponse. C'est ce que dit le grand manuscrit.",
  'cmd_man_not_found': "Il n'y a rien d'écrit dans le grand manuscrit.",
  'cmd_mv_done':  "Moved %s to %s.",
  'cmd_mv_flood':  "You need to move thing A to place B. Use mov [thingA] [placeB].",
  'cmd_mv_invalid':  "Must be a valid item and location to move it.",
  'cmd_pwd':"Tu te trouve dans %s.",
  ...
  'cmd_unknown':"You have not learned this spell yet",
  'combo':"The combination is 'terminus' (without the quotes).",
  'directions': "Lieux:\n%s ",
  'incorrect_syntax':"Incorrect syntax. Ask the OldMan for help.",
  'invalid_locker': "Je ne connais pas ce nom de verrou.",
  'invalid_spell': "Ce sort n'existe pas",
  'items': "Objets:\n%s",
  'lock_added':"You just added the %s locker",
  ...
  'room_none':"Pièce banale",
  'room_none_text':"C'est une pièce très banale.",

  'room_home':'Dossier Personnel',
  'room_home_text':"\
Tu es confortablement installé dans ton dossier personnel; \n\
c'est là où tu ranges toutes tes affaires. \n\
Disons que c'est ici ta maison.",

  // LEVEL 1
  'room_western_forest':'BoisDesLutins',
  'room_western_forest_text':"\
...
\"Académie des Bots : Grande école de Sorcellerie du Grand Ordinateur. \"",
  ...
  'room_spell_casting_academy_text' : "\
L'entrée, les salles, même les toilettes sont sont bondées.\n\
Les Bots s'agitent de droite à gauche et de gauche à droite \
...
pour ne pas jeter de soupsons sur vous.", 
  ...
  'item_western_forest_academy_direction_text':"\
Académie des Bots : Grande école de Sorcellerie du Grand Ordinateur.\n\
À ne pas manquez aujourd'hui : Leçon d'initiation aux sortilèges !",

  'item_western_forest_back_direction':'RentreChezToi',
  'item_western_forest_back_direction_text':"\
À tous moment, si tu veux revenir dans le dossier personnel, \n\
écris juste la commande 'cd ~' ou 'cd'  et tu seras de retour chez toi.\n\
C'est plus simple que demander son chemin.",

  'item_welcome_letter':'LettreDeBienvenue',

  // the welcome letter is the first prompt of the game engine, don't remove it
  'item_welcome_letter_text':"\
Bienvenue à toi apprenti sorcier ! \n\
Pour réussir ta quête, tu devra écrire des sorts magiques appelées\n\
commandes.\n\
Ces commandes te permettront de te déplacer et de comprendre le monde \n\
plus rapidement que le commun des mortels. \n\n\
Observe l'endroit où tu te trouve avec la commande \"ls\". \n\
...
Si tu as la flemme d'écrire les noms en entier, appuis sur la touche TAB.\n\
\nMaintenant explore et va de l'avant.",
  ...
  'room_academy_practice_text' : "\
La pièce est remplie de noobs comme vous et \
d'élèves pratiquant leur nouveaux sortilèges.",

  'item_academy_practice' : "LeçonDInitiation", 
  'item_academy_practice_text' : "\
Welcome to the Practice Room. Here you will find practice dummies \n\
try your new spells on. Go ahead, give it a go! ",
  ...
  'room_meadow':"Prairie", 
  'room_meadow_text':"C'est une grande et belle prairie verte. Un majesteux poney s'y trouve. Il a l'air triste et solitaire.",

  'people_poney':"Poney",
  'people_poney_text':"Sans t'approcher.\
...
Finalement, le poney regardait vers l'est comme s'il te suggérait d'aller dans cette direction.", 
  ...
  'people_academy_student':"BotPressé-e", 
  'people_academy_student_text':"\
...
The professor is difficult to understand,\n\
...
I may have forgotten to mention that before I sold it to you...\"",
   ...
   'item_rm_spell_text':"\
\"Ah, yes, the rm spell,\" the Vendor muses. \n\
...
Richard Stallman shall be proud of you.",
  ...
  'item_mkdir_spell_text': "\
\"Make dreams into reality. Just say \"mkdir\" followed by any name that\n\
...
It looks like an interesting book, but it's way too long and \n\
...
The book says : \"If you ever get lonely for Home,\n\
...
item_vimbook_text:"\
While you open this book, a glow illuminates your eyes. \n\
...
Where ITEM is the name of the thing you want to create. \
...
room_farm:"Farm",
room_farm_text:"\
There was once a farm of some sort here,\n\
...
people_farmer_text:"\
\"Ruined! I'm ruined! Look at these crops... almost nothing left!\n\
...
I could really use AnotherEarOfCorn! \"",


room_clearing:"Clearing", 
room_clearing_text: "\
There's a small grassy clearing here, with a man sitting on a stone, weeping.\n\
...
by making me a new House!\"",
  ...
  room_brokenbridge_text: "\
A creaky wooden bridges stretches across a chasm.\n\
But it's missing a Plank, and the gap is too far to jump.",
  item_plank:"Plank",
 

  room_ominouspath:"OminousLookingPath", 
  room_ominouspath_text:"\
...
some reason it fills you with a sense of dread.",
  ...
  item_brambles_text: "This thicket of brambles is covered with wicked-looking thorns. You \
...
deep blue. After fizzling for a minute, they disappear with a puff of smoke.",
  ...
  room_kernel_text:"The KernelFiles hold the sudo-secret (no, not \
pseudo). You'd better read the Instructions.",
  room_kernel_sudo:"Password:",
  room_kernel_IHTFP:"You have correctly entered the password. You are now in Paradise. \
Take a look around, and congratulations.",
  ...
  item_instructions_text:"You've learned how to make use of your friend grep I see. \
...
Use this knowledge wisely. Remember.... you can't undo an 'rm' spell.",
  ...
  people_supertroll_rm: "The troll belches spectacularly, and you could swear he actually smirks. \
...
Also he will probably eat you.",
  ...
  room_cage_cd:"You can’t squeeze through the bars. Anyway, are you crazy? \
...
runs up the ominous path towards home.",
  ...
  room_cluster:"AthenaCluster",
  room_cluster_text: "None shall pass without the combination. You \n\
have one chance to enter the combination. Enter password:",
  room_cluster_ls: "You must enter the Athena cluster combo first.",
  room_cluster_cd:"None shall pass without the combination. You\n\
have one chance to enter the combination. Enter password:",


  item_workstation:"Workstation",
  item_workstation_text:"The Workstation has resources you can use to \n\
...
",
  ...
  room_mit:"MIT",
  room_mit_text:"You have arrived by magic carpet to MIT!",
  room_mit_terminus:"You have correctly entered the cluster combo. Entering the AthenaCluster.",

  item_mitletter:"AdmissionLetter",
  item_mitletter_text:"Congratulations on entering MIT! \n\
Here you will learn special spells that you can only use at MIT. Enjoy!",

  room_stata:"StataCenter",
  room_stata_text: "The center of computer science and artificial intelligence research at MIT. Lots of \
magic happens here, including TAs, grad students, etc.",

  people_gradstudent:"WaryEyeOfGradStudent",
...
learn how.",
  ...
  people_assistant:'HelpfulTA',
  people_assistant_text: "Ah, welcome to the wonderful land of Stata. \n\
There's one room here that you'll need the combination for. All you have to do is ask:\n\
'tellme combo'.",

  room_magiclocker:"MagicLocker",
  room_magiclocker_text:"This contains items and spells that can be used \
anywhere in the world after you add the locker. More is coming.",

    item_morecoming:"MoreComing",
    item_morecoming_text:"The MagicLocker contains Items that can be \n\
...
",
  "man_man": "\
Je suis le manuscrit ancien, et je possède le savoir indispensable aux sorciers.\n\
Voici les sorts que je pourais t'enseigner : cd, ls, rm, mv, exit, help, man, touch, grep, pwd.\
", 
  "man_help": "Écris \"man COMMANDE\" si tu as oublié comment utiliser une commande.", 
  "man_exit": "\
(quitter) \n\
Utilises \"exit\" pour quitter le jeu.\
", 
  "man cp": "\
(CoPy)\n\
...
", 
  "man_tellme": "\
(tellme combo)\
tells you the combination for the AthenaCluster rooms at MIT.\n\
Il faut écrire :\n\
  tellme combo\
",
  };
